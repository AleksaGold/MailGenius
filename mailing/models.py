...
class MailingSettings(models.Model):
    ...
    ONCE_A_WEEK = 'OW'
    ONCE_A_MONTH = 'OM'
    FREQUENCY_CHOICES = [(ONCE_A_DAY, 'Раз в день'), (ONCE_A_WEEK, 'Раз в неделю'), (ONCE_A_MONTH, 'Раз в месяц')]

    start_from = models.DateTimeField(auto_now=False, verbose_name='Дата и время начала рассылки')
    frequency = models.CharField(max_length=2, choices=FREQUENCY_CHOICES, verbose_name='Периодичность')
